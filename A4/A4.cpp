...
public:
	...
	int deleteVertex(string);
	Node* deleteEdge(Node * t,string c);
...
int Graph::deleteVertex(string c){
     int flag1=0;
     node *t1=start1;
     if(start1->city==c){
                         flag1=0;
...
Node* Graph::deleteEdge(Node * t,string c){
     int flag=0;
     if(t->city==c){
        t=t->next;
        flag=1;
...
int main() {
    ...
    case 3:
     ...
     case 4:
    	       cout<<"Enter the City whose Indegree is to be calculated - "<<endl;
    	    	    cin>>city;
    	    	    obj.indegree(city);
    	            break;
